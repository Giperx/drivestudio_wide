...
CUDA_VISIBLE_DEVICES=0 python tools/train.py \
    ...
    --project omnire \
    --run_name 3cams260fd2 \
    dataset=nuscenes/3cams \
    data.scene_idx=260 \
    data.start_timestep=0 \
    data.end_timestep=-1 \
    'data.pixel_source.cameras=[0,1,2]' \
    'data.pixel_source.train448=True'
...
CUDA_VISIBLE_DEVICES=1 python tools/train.py \
    ...
    data.start_timestep=0 \
    data.end_timestep=-1 \
    'data.pixel_source.cameras=[5,4,3]'

CUDA_VISIBLE_DEVICES=1 python tools/train.py \
    --config_file configs/pvg.yaml \
    --output_root logs/pvg_nuscenes/ \
    --project pvg \
    --run_name 3cams037fd2 \
    dataset=nuscenes/3cams \
    data.scene_idx=37 \
    data.start_timestep=0 \
    data.end_timestep=-1
...
CUDA_VISIBLE_DEVICES=1 python tools/train.py \
    ...
    --output_root logs/streetgs_nuscenes/ \
    --project streetgs \
    --run_name 3cams037fd2 \
    dataset=nuscenes/3cams \
    data.scene_idx=37 \
