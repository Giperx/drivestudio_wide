...
**1. Update submodules and set up the environment:**
   ...
   pip install git+https://github.com/brjathu/PHALP.git --no-build-isolation
   pip install git+https://github.com/facebookresearch/pytorch3d.git --no-build-isolation
   pip install "pytorch-lightning<2.0.0" smplx==0.1.28 pyrender opencv-python yacs scikit-image einops
   pip install scikit-learn==1.3.0 scipy==1.11.4 -i https://pypi.tuna.tsinghua.edu.cn/simple
   
   # Return to the project root
   cd ../..
   ```
   pip install -e . --no-deps --no-build-isolation
   cp /home/test/LIVA/XZP/FeedForward/drivestudio/smpl_models/SMPL_NEUTRAL.pkl  ~/.cache/phalp/3D/models/smpl/SMPL_NEUTRAL.pkl
   cp /home/test/LIVA/XZP/FeedForward/drivestudio/smpl_models/SMPL_NEUTRAL.pkl ./data/basicModel_neutral_lbs_10_207_0_v1.0.0.pkl
...
CUDA_VISIBLE_DEVICES=0 python datasets/tools/humanpose_process.py --dataset nuscenes --data_root data/nuscenes/processed_10Hz/trainval --scene_ids 800
