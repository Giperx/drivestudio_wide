...
#-- Install mmcv-full
pip install timm==0.3.2 pylint debugpy opencv-python-headless attrs ipython tqdm imageio scikit-image omegaconf -i https://pypi.tuna.tsinghua.edu.cn/simple
pip install setuptools==59.6.0  -i https://pypi.tuna.tsinghua.edu.cn/simple
pip install mmcv-full==1.2.7 --no-cache-dir -i https://pypi.tuna.tsinghua.edu.cn/simple
