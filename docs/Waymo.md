...
CUDA_VISIBLE_DEVICES=7 python datasets/tools/extract_masks.py \
    --data_root data/waymo_me/validation_me/validation \                            
    --segformer_path=./SegFormer \
    --checkpoint=./SegFormer/segformer.b5.1024x1024.city.160k.pth \
    --start_idx 0 \
    --num_scenes 202 \
...
CUDA_VISIBLE_DEVICES=1 python datasets/tools/extract_masks.py \
    --data_root data/waymo_me/training_me/training \
    --segformer_path=./SegFormer \
    --checkpoint=./SegFormer/segformer.b5.1024x1024.city.160k.pth \
    --start_idx 200 \
    --num_scenes 200 \
